...
function printInputsPart1() {
  // 1. Cria novos elementos com base nos dados inseridos
  // 1.1 Elementos do form__first
...
// for (const choice of familyChosen) {
//   if (choice.checked) familyValue = choice.value;
// }

const subjectsChosen = [];

// function printInputsPart2a2() {
...
function printInputsPart3() {
  // 3. Cria novos elementos com base nos dados inseridos
  // 3.1 Elementos do form__third
  // for (const r of rate) {
...
submitBtn.addEventListener('click', (e) => {
  // 1. Previne que o submit button recarregue a página
  e.preventDefault();
  printInputsPart1();
