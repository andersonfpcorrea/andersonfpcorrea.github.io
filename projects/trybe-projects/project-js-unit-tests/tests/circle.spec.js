...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    // Teste se o objeto retornado possui 3 propriedades. ==OK==
    // Teste se a função, quando não recebe nenhum parâmetro, retorna undefined. ==OK==
    // Teste se dentro do objeto retornado, a função retorna uma `key` com `value` igual à circunferência correta para um círculo de raio 2. ==OK==
    // Teste se dentro do objeto retornado, a função retorna uma `key` com `value` igual à área correta para um círculo de raio 3. ==OK==
    // Teste se a função retorna, em um objeto, os dados corretos de um círculo de raio 3. ==OK==
  });
});
